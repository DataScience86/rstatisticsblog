...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.54fc7f7201a55ca1e1a2bd352edb9d8291eece8e7e8f97facad9a34611223a02.js',function(){input.required=false;search();});}
