...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ebbf2175f90d3d9f88a6d257a605f8ccc7d7711e1a38fcff2d40624230c500a1.js',function(){input.required=false;search();});}
