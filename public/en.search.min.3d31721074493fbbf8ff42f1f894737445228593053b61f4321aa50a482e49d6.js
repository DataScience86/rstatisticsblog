...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.93eaf37cc347a19697a6899bc399837bedab830526339e6ec53f2932af6e1a0f.js',function(){input.required=false;search();});}
